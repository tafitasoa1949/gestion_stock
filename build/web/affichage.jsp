...
<%
   String produit = (String)request.getAttribute("produit");
                       ...
                       <div class="card">
                           <div class="card-body">
                                  <form method="get" action="">
                                      <div class="col-12">
                                          <h4 class="card-title">Produit : <%= produit %></h4>
                                      </div>
                                      <div class="col-12">
                                          <h4 class="card-title">Prix moyenne ponderee : <%= prix %></h4>
                                      </div> 
                                </form>
                            </div>
                        </div>
