                                    ...
                                    <tbody>
                                        <% for(int i=0 ; i< list_Allfab.size() ; i++){ %>
                                         <tr>
                                            ...
                                            <td><%= list_Allfab.get(i).getPrice() %></td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>
                           ...
                           <div class="card-body">
                               ...
                               <form class="row g-3" method="get" action="http://localhost:8080/GestionStock/FabricationServlet">
                                    ...
                                    <%  if(request.getAttribute("resultat") != null){
                                            validation = (boolean)request.getAttribute("resultat");
                                            ...
                                            <% } %>
                                    <% } %>
                                    <%  if(request.getAttribute("fonctiondiso") != null){
                                            fonctiondiso = (String)request.getAttribute("fonctiondiso");
                                            if( fonctiondiso != null ){ %>                                    
                                            <div class="text-center">
                                                <h5 style="color: red" class="card-title"><%= fonctiondiso %></h5>
                                            </div> 
                                            <% } %>
                                    <% } %>
