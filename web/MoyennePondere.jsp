...
<%
   ...
   DAO da = new DAO();
   Vector<Stock> list = da.get_AllStock(co);
%>
<!DOCTYPE html>
<html lang="en">
                ...
                <section class="section">
                  <div class="row">
                    <div class="col-lg-6">
                       <div class="card">
                           <div class="card-body">
                               <h5 class="card-title">Prix moyenne pronderee par produit</h5>
                                  <form method="get" action="http://localhost:8080/GestionStock/MoyenneServlet">
                                   <label for="inputState" class="form-label">Type produit primaire</label>
                                    <div class="col-md-12">
                                            <select name="produit" id="inputState" class="form-select">
                                                <option selected>Choose...</option>
                                                <% for(int i=0 ; i< list.size() ; i++) { %>
                                                    <option value="<%= list.get(i).getProduit() %>"><%= list.get(i).getProduit() %></option>
                                                <% } %>
                                            </select>
                                      </div >
