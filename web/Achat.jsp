...
<%
    ...
    Vector<Achat> list_achat = new DAO().get_AllAchat(co);
%>
<!DOCTYPE html>
<html lang="en">
                ...
                <section class="section">
                  <div class="row">
                       ...
                       <div class="card">
                           <div class="card-body">
                                <table class="table" class="col-lg-8">
                                    ...
                                    <tbody>
                                        <% for(int i=0 ; i< list_achat.size() ; i++){ %>
                                         <tr class="table-dark">
                                            <th scope="row"><%= list_achat.get(i).getProduit() %></th>
                                            <td><%= list_achat.get(i).getPrice() %></td>
                                            <td><%= list_achat.get(i).getQuantite() %></td>
                                            <td><%= list_achat.get(i).getDaty() %></td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-lg-4">
                       <div class="card">
                           <div class="card-body">
                               <h5 class="card-title">Ajouter un achat</h5>
                               <form class="row g-3" method="get" action="http://localhost:8080/GestionStock/AchatServlet">
                                <div class="col-md-12">
